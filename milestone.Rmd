...
As this report is supposed to be read by non-data-scientists you will not find any R-Code in it. If you are interested in the R-Code you can see it in my ([github account](https://github.com/mikhilraj/Data_Science_Capstone)).
...
```{r echo=FALSE}
setwd("/Users/mikhilraj/Downloads/Project/final")
